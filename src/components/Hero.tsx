                ...
                <div className="flex items-center w-full lg:w-1/2">
                    <div className="max-w-2xl mb-8">
                        <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
                            Intelligent Technology Solutions for a Smarter
                            Future
                        </h1>
                        <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
                            NextWorks delivers cutting-edge software
                            development, AI integration, smart office & home
                            automation, and comprehensive ICT infrastructure.
                            We&apos;re also committed to developing the next
                            generation of tech talent through education and
                            mentorship.
                        </p>
                ...
                <div className="flex items-center justify-center w-full lg:w-1/2">
                    <div className="">
                        <Image
                            ...
                            alt="NextWorks AI and Technology Solutions"
                            loading="eager"
                            placeholder="blur"
                        />
                    </div>
            ...
            <Container>
                <div className="flex flex-col justify-center">
                    <div className="text-xl text-center text-gray-700 dark:text-white">
                        ...
                        organizations and growing tech talent across Africa
                    </div>
...
function TechEducationLogo() {
    return (
        <svg width="110" height="33" viewBox="0 0 110 33" fill="currentColor">
            <path d="M25 8l30 15-30 15-30-15z" />
            <path
                d="M55 23v10M35 15v15M45 18v12"
                stroke="currentColor"
                strokeWidth="2"
            />
